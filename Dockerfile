...
COPY --from=builder /app/target/241CC341SpringSigatBackend-0.0.1-SNAPSHOT.jar /app/241CC341SpringSigatBackend.jar

# Puerto en el que la aplicación Spring Boot escuchará las solicitudes
EXPOSE 8080

# Comando para ejecutar la aplicación al iniciar el contenedor
CMD ["java", "-jar", "/app/241CC341SpringSigatBackend.jar"]